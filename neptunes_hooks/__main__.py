...
def main():
    ...
    CONSOLE.panel("Welcome to Neptune's Pride", expand=False, style="bold blue", justify="center")
    ...
    while response and response["Active"]:
        ...
        if response["Tick"] > SETTINGS.last_tick or args.debug:
            ...
            CONSOLE.rule(f"Turn {turn:02}", style="blue")
            ...
            SETTINGS.save()
            CONSOLE.print("Waiting for next turn...")
        if args.debug:
            break
